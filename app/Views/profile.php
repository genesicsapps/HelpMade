    ...
    <div class="profile-sidebar profile-sidebar-two pd-lg-r-15">
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 col-lg-12">
          <div class="avatar avatar-xxl avatar-online"><img src="https://placehold.co/500" class="rounded-circle" alt=""></div>
        </div><!-- col -->
    ...
    <div class="media-body mg-t-40 mg-lg-t-0 pd-lg-x-10">
      <div class="profile-update-option bg-white ht-50 bd d-flex justify-content-end mg-b-20 mg-lg-b-25 rounded">
        ...
        <div class="wd-50 bd-l d-flex align-items-center justify-content-center">
          <a href="" class="link-03" data-bs-toggle="tooltip" title="Publish Photo"><i data-feather="image"></i></a>
        </div>
        <div class="wd-50 bd-l d-flex align-items-center justify-content-center">
          <a href="" class="link-03" data-bs-toggle="tooltip" title="Publish Video"><i data-feather="video"></i></a>
        </div>
        <div class="wd-50 bd-l d-flex align-items-center justify-content-center">
          <a href="" class="link-03" data-bs-toggle="tooltip" title="Write an Article"><i data-feather="file-text"></i></a>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-sm-6 col-md-5 col-lg-12">
          ...
          <ul class="list-unstyled media-list mg-b-15">
            ...
            <li class="media align-items-center">
              <a href=""><div class="avatar avatar-offline"><img src="https://placehold.co/500" class="rounded-circle" alt=""></div></a>
              <div class="media-body pd-l-15">
          ...
          <a href="" class="link-03 d-inline-flex align-items-center">See more stories <ion-icon name="chevron-down-outline" class="tx-12"></ion-icon></a>
        </div><!-- col -->
        <div class="col-sm-6 col-md-5 col-lg-12 mg-t-40 mg-sm-t-0 mg-lg-t-40">
          <div class="d-flex align-items-center justify-content-between mg-b-20">
            <h6 class="tx-13 tx-spacing-1 tx-uppercase tx-semibold mg-b-0">People Also Viewed</h6>
          </div>
          <ul class="list-unstyled media-list mg-b-15">
            <li class="media align-items-center">
              <a href=""><div class="avatar avatar-online"><img src="https://placehold.co/500" class="rounded-circle" alt=""></div></a>
              <div class="media-body pd-l-15">
        ...
        <div class="col-sm-6 col-md-5 col-lg-12 mg-t-40">
          ...
          <ul class="list-unstyled media-list mg-b-15">
            <li class="media align-items-center">
              <a href=""><div class="avatar"><img src="https://placehold.co/500" class="rounded-circle" alt=""></div></a>
              <div class="media-body pd-l-15">
        ...
        <div class="col-sm-6 col-md-5 col-lg-12 mg-t-40 order-sm-1">
          ...
          <div class="img-group img-group-mutual mg-b-20 justify-content-start">
            <img src="https://placehold.co/500" class="img rounded-circle" alt="">
            <img src="https://placehold.co/500" class="img rounded-circle" alt="">
            <img src="https://placehold.co/500" class="img rounded-circle" alt="">
            <img src="https://placehold.co/500" class="img rounded-circle" alt="">
            <img src="https://placehold.co/500" class="img rounded-circle" alt="">
        ...
        <div class="col-sm-6 col-md-5 col-lg-12 mg-t-40">
          ...
          <div class="row row-xxs">
            <div class="col-4">
              <a href="" class="d-block ht-60"><img src="https://placehold.co/300" class="img-fit-cover" alt=""></a>
            </div><!-- col -->
            <div class="col-4">
              <a href="" class="d-block ht-60"><img src="https://placehold.co/500x281" class="img-fit-cover" alt=""></a>
            </div><!-- col -->
            <div class="col-4">
              <a href="" class="d-block ht-60"><img src="https://placehold.co/500x281" class="img-fit-cover" alt=""></a>
            </div><!-- col -->
            ...
            <div class="col-4 mg-t-2">
              <a href="" class="d-block ht-60"><img src="https://placehold.co/500" class="img-fit-cover" alt=""></a>
            </div><!-- col -->
            <div class="col-4 mg-t-2">
              <a href="" class="d-block ht-60"><img src="https://placehold.co/500" class="img-fit-cover" alt=""></a>
            </div><!-- col -->
