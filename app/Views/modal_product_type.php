<div class="modal fade" id="productTypeModal" tabindex="-1" aria-labelledby="exampleModalLabel6" style="display: none;" aria-hidden="true">
    ...
    <div class="modal-content tx-14">
        ...
        <div class="modal-body" id="maincontent">
            <div class="row">
                ...
                <div class="col-10">
                    <label class="d-block">Product type name</label>
                    <input id="productType_name" type="text"  class="form-control focus" placeholder="Product type name" >
                </div>
                <div class="col-12">
        ...
        <button type="button" id = "SeriesBtnSave" onclick="saveProductType()" class="btn btn-primary tx-13">Save</button>
        </div>
    </div>
    </div>
</div>
