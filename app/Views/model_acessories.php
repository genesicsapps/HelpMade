<script src="<?php echo getJSPath('logic/model_acessories.js') ?>"></script>
<style>
        .full-screen-div {
    ...
    <div class="tab-content bd bd-gray-400 bd-t-0 pd-10 full-screen-div" id="myTabContent">
        ...
        <div id="maincontent" class="row" novalidate>
            <div class="row row-sm">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 mg-t-10">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 mg-t-10">
                    ...
                    <input id="qty" type="number" name="text" class="form-control" placeholder="Qty">
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 mg-t-10">
                    <label class="d-block">Unit</label>
                    <input id="unit" type="number" name="text" class="form-control" placeholder="Unit">
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 mg-t-10">
